...
VOCAB = pickle.load(open("../../../Data/top500WOS1grams.p","rb")) + pickle.load(open("../../../Data/top500WOS2grams.p","rb"))
...
def main():
    ...
    nn_clf = tf.keras.models.load_model("../../../Data/dnnWOSModel.h5")
    nn_clf_history = pickle.load(open("../../../Data/dnnWOSTrainHistory.p","rb"))
    ...
    with open("../../../Data/ROC_Curves/DNN WOS.p","wb") as handle:
