...
VOCAB = list(pickle.load(open("../../../Data/Data/top500relabeledNSFfiltered1grams.p","rb"))) + list(pickle.load(open("../../../Data/Data/top500relabeledNSFfiltered2grams.p","rb")))
...
def main():
	...
	nn_clf.save("../../../Data/dnnNSFModel.h5")

	with open("../../../Data/dnnNSFTrainHistory.p","wb") as handle:
