...
VOCAB = pickle.load(open("top500WOS1grams.p","rb")) + pickle.load(open("top500WOS2grams.p","rb"))
...
def main():
	...
	nn_clf.save("dnnWOSModel.h5")

	with open("dnnWOSTrainHistory.p","wb") as handle:
